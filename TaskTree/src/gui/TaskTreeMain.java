...
public class TaskTreeMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(856, 551));
        setResizable(false);
        ...
        openCurrentButton2.setFont(new java.awt.Font("Courier New", 1, 17)); // NOI18N
        openCurrentButton2.setForeground(new java.awt.Color(255, 255, 255));
        openCurrentButton2.setText("+ Add Task");
        openCurrentButton2.setBorderPainted(false);
        openCurrentButton2.setContentAreaFilled(false);
        openCurrentButton2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        openCurrentButton2.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);
        openCurrentButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                openCurrentButton2ActionPerformed(evt);
            }
        });
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TaskTreeMain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TaskTreeMain().setVisible(true);
            }
        });
    }
